...
skillset = GUI.ScrollableList('list', 3.0, 31.0, 206.0, 148.0, 23, columns, rows, 8, cancelcallback)
...
# skillset = GUI.ScrollableList('shadowed', 73, -32, 62.0, 43.0, 16, columns, rows, 2, cancelcallback)
...
# skillset = GUI.ScrollableList('list', -31, 35, 170.0, 148.0, 23, columns, rows, 8, cancelcallback)
